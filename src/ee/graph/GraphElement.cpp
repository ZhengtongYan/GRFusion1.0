...
GraphElement::GraphElement(unsigned id, char* tupleData, GraphView* graphView, bool remote)
{
	this->m_id = id;
...
void GraphElement::setId(unsigned id)
{
	this->m_id = id;
}

// int GraphElement::getId()
unsigned GraphElement::getId() // LX FEAT2
{
	return this->m_id;
}
